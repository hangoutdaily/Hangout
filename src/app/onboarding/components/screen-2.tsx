...
export function Screen2({ data, onChange }: Screen2Props) {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-2">
        ...
        <p className="text-base text-muted-foreground font-normal">We’re building your profile. Not a resume. Just the cool stuff.</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-3">
          <Label htmlFor="lookingFor" className="text-sm font-medium text-foreground">
            What are you looking for on Hangout?
          </Label>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <Label className="text-sm font-medium text-foreground">Pick 3 traits that describe you</Label>
            <span
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <Label className="text-sm font-medium text-foreground">What are you into?</Label>
            <span
              className={`text-xs font-medium px-2 py-1 rounded ${
        ...
        <div className="space-y-3">
          <Label htmlFor="joyfulMoment" className="text-sm font-medium text-foreground">
            What's your most joyful moment?
          </Label>
          <p className="text-xs text-muted-foreground">
